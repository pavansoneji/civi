...
import AIAgents from "@/pages/products/ai-agents";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Switch>
          ...
          <Route path="/products/case-management" component={CaseManagement} />
          <Route path="/products/learning-management" component={LearningManagement} />
          <Route path="/products/ai-agents" component={AIAgents} />
